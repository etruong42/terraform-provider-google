...
func resourceMonitoringGenericServiceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	nameProp, err := expandMonitoringGenericServiceServiceId(d.Get("service_id"), d, config)
	if err != nil {
		return err
	...
	obj, err = resourceMonitoringGenericServiceEncoder(d, meta, obj)
	if err != nil {
		return err
	}
...
func resourceMonitoringGenericServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("service_id", flattenMonitoringGenericServiceServiceId(res["name"], d, config)); err != nil {
		return fmt.Errorf("Error reading GenericService: %s", err)
	}
...
func flattenMonitoringGenericServiceServiceId(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
...
func expandMonitoringGenericServiceServiceId(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func resourceMonitoringGenericServiceEncoder(d *schema.ResourceData, meta interface{}, obj map[string]interface{}) (map[string]interface{}, error) {
